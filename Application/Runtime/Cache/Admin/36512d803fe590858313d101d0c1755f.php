...
<div id="main-wrapper" class="main-wrapper">
    ...
    <div id="content" class="content container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <div class="page-header">
                    <ol class="breadcrumb">
                        <li><a href="<?php echo U('Admin/Column/columnList');?>">广告管理</a></li>
        ...
        <div class="content-box big-box">
            <h4 class="zero-m" align="center">广告列表</h4>
            <div class="table-responsive">
                <table class="table table-hover ">
                    <caption><a class="btn btn-primary" href="/index.php/Admin/Advertisement/showAddAdvertisement">添加广告</a></caption>
                    <thead>
                    <tr>
                        <th>操作</th>
                        <th>标题</th>
                    ...
                    <tbody>
                        <!--顶级分类-->
                        <?php if(is_array($advertisementList)): $i = 0; $__LIST__ = $advertisementList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                <td><a class="btn btn-primary btn-sm u" href="/index.php/Admin/Advertisement/showAdvertisementDetail?id=<?php echo ($vo["ggao_id"]); ?>">修改</a> <a class="btn btn-primary btn-sm r" href="javascript:void(0)" uid="<?php echo ($vo["ggao_id"]); ?>">删除</a></td>
                                <td><?php echo ($vo["ggao_biaoti"]); ?></td>
                                <td><?php echo ($vo["ggao_lianjie"]); ?></td>
                                <td><img src="<?php echo CheckImg($vo['ggao_tupian']);?>" alt="图片" width="35px" height="35px" title="图片"></td>
    ...
    $(window).ready(function(){
        ...
        $('.btn.btn-primary.btn-sm.r').click(function(){
            ...
            $.confirm({
                ...
                confirm: function(){
                    $.ajax({
                        url:'/index.php/Admin/Advertisement/removeAdvertisement',
                        data:{"id":id},
                        type:'post',
...
<!-- Mirrored from 91.234.35.26/advantage-admin/tables.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 Oct 2016 03:37:34 GMT -->
</html>