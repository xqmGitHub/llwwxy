        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="page-header">
                    <ol class="breadcrumb">
                        <li><a href="/index.php/Admin/User/userList">广告管理</a></li>
        ...
        <div class="content-box big-box">
            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered">
                    <?php if(is_array($advertisementInfo)): $i = 0; $__LIST__ = $advertisementInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><input type="hidden" value="<?php echo ($vo["ggao_id"]); ?>" name="id">
                        <tr>
                            <th>标题</th>
                            <td><input type="text" name="ggao_biaoti" value="<?php echo ($vo["ggao_biaoti"]); ?>" required="required"></td>
                            <th>链接</th>
                            <td><input type="text" name="ggao_lianjie" value="<?php echo ($vo["ggao_lianjie"]); ?>"></td>

                        </tr>
                        <tr>
                            <th>图片</th>
                            <td>
                                <img src="<?php echo CheckImg($vo['ggao_tupian']);?>" alt="图片" width="50px" height="50px">
                            </td>
                            <th>修改图片</th>
                            <td><input type="file" name="ggao_tupian"></td>
                        </tr>
                        <tr><td colspan="4" align="center"><input type="submit" value="修改" id="editUser" class="btn btn-primary btn-sm"></td></tr><?php endforeach; endif; else: echo "" ;endif; ?>
                </table>
                </form>
            </div>
        </div>
...
//            $dataForm=$(this).serialize();
            ...
            $.ajax({
                url:"/index.php/Admin/Advertisement/editAdvertisement",
                data:formData,
                type:'post',
                ...
                success:function(msg){
                    if(msg.status==1){
                        ...
                        setTimeout('window.location.href="/index.php/Admin/Advertisement/advertisementList"', 1500);
                    }else{
                        $('body').overhang({
                            type: 'warn',
                            message: '修改失败'
